...
{
    public partial class OrderGraph : UserControl //Palace.UserClass.PalaceControl
    {
        #region 属性表
...
//this.InvalidateKeel(this.selectSZoneWall);
//this.InvalidateRect(this._selectSZone.Remark.DispRect, 20);
//this.InvalidateKeel(this.selectSZoneWall);
//this.InvalidateRect(this._selectSZone.DispRect, 20);
//this.InvalidateRect(this._selectSZone.Remark.DispRect, 20);

//PointF ba = new PointF(ceiling.Left, ceiling.Top);
//this.productSet.KeelSet.Trans(angle, center);
//this.productSet.GenerateActualRegion();
//this.productSet.GenerateDrawingRegion();
//this.productSet.Trans(angle == 90 ? 1 : -1);
//this.productSet.BuckleSet.Trans(angle == 90 ? 1 : -1);

//if (buckleset.Products != null)
//    arg.products = buckleset.Products.Clone() as AupuBuckle[];

//this.ceiling.SetDrawingRect(new Rectangle(ceilingRow.display_left,
//    ceilingRow.display_top,
//    ceilingRow.display_width, ceilingRow.display_height));
//this.ceiling.RefrushRegion();
//this.productSet.GenerateActualRegion();
...
//sZones[i].ParseData(this.ceiling, _szones[i]);
//this.RefrushGraph(new Rectangle(ceilingRow.display_left,
//    ceilingRow.display_top,
//    ceilingRow.display_width, ceilingRow.display_height));
//this.Invalidate();
...
//            + (this.ceiling.Name == null || this.ceiling.Name.Length == 0 
//            ? "" : " - " + this.ceiling.Name);
//    }
//}
...
//ProductRevocationEventArgs arg = new ProductRevocationEventArgs();
//arg.productSet = this.productSet;
//arg.add_Products = this.productSet.BuckleSet.TransSelection();
//this.AddUndo(arg, Revocation.Products);

//revo_arg.keel = this.keel;
//revo_arg.ceiling = this.ceiling;
//revo_arg.productSet = this.productSet;
...
//this.ceiling.Trans(90, ca, cd);
//this.productSet.Trans(90, ba, ca, cd);

//for (int i = 0; i < this.sZones.Count; i++)
//{
//    sZones[i].Trans(90, ceiling);
//}

//revo_arg.productSet = this.productSet;
//this.productSet.KeelSet.RevoSetKeel(orien, revo_arg);
...
//if (this.wallFuzhu)
//{
//    Rectangle rect = this.szone.DispRect;
//    this.CancelDrawWall();
//    this.Invalidate(rect);
//}
//else if (this.draft)
...
//    Rectangle rect = this.ceiling.DrawingRect;
//    this.CancelDraft();
//    this.InvalidateRect(rect, 50);
//}
//else if (this.keelFilling)
//{
//    Rectangle rect = this.keel.PaintRect;
//    this.CancelFillKeel();
//    this.InvalidateRect(rect, 50);
//}
//else
...
//this.Invalidate();
//RefrushGraph();
//editer.SetData(e.Keel);
//editer.SetData(e.Keel);

//public void RefrushGraph()
//{
//    //this.SetCeilingRect(this.ceiling.DrawingRect);
//    this.DisplayCeiling();
//    this.Invalidate();
//}

//else if (this.wallFuzhu && this.keel != null)
//{
//    this.DraftKeel(this.keel, e.Location);
//    this.keel.End = this.ceiling.GetLogicCoord(this.keel.EndPaintPoint);
//    this.PositionTip(this.keel);
//    this.InvalidateKeel(this.keel);
//}

//int index = this.ceiling.GetWall(e.Location);
//if (index > -1)
//    str = "自由墙" + index;
//else if (this.productSet.SelectKeel(e.Location) > -1)
//    str = "主龙骨";
...
//sZones[i].DrawSelectFlag(graphics, selectedPen);
//_wls[j].DrawRemark(graphics, lengthFont, this.ceiling.Depth);
//sZones[i].Remark.Draw(graphics, lengthFont, arrowPen);
//List<Keel> aks = this.productSet.KeelSet.MainKeelList;
//for (int j = 0; j < aks.Count; j++)
//{
//    aks[j].DrawRemark(graphics, lengthFont, this.ceiling.Depth, arrowPen);
//}

//List<Wall> _wls = this.ceiling.Walles;
//for (int j = 0; j < _wls.Count; j++)
//{
//    _wls[j].DrawRemark(graphics, lengthFont, arrowPen);
//}

//for (int i = 0; i < sZones.Count; i++)
//{
//    sZones[i].DrawRemark(graphics, lengthFont, arrowPen);
//}

//if (szone != null && !this.wallFuzhu)
//    szone.DrawSelectFlag(e.Graphics, mainKeelPen);

//else if (this.cWall != null)
//{
//    e.Graphics.DrawLine(mainKeelPen, this.cWall.BeginPaintPoint, 
//        this.cWall.EndPaintPoint);
//    this.cWall.DrawLength(this.ceiling.Clockwise, e.Graphics,
...
//if (!this.keelFilling && !this.wallFuzhu)
//    this.keel.DrawSelectedFlag(e.Graphics, this.selectedPen,
//        lengthFont);
...
//    return;
//}
//this.keel = this.productSet.GetKeel(index);

//if (this.ceiling.SelectedIndex != -1 && this.ceiling.SelectedIndex != index)
//{
//    InvalidateRect(SelectedWall.PaintRect);
//}
//_SelectWall(index);

//private void _SelectWall(int index)
//{
//    Wall wall = this.ceiling.SelectedWall;

//    if( this.ceiling.SelectedWall != null && index < 0)
//    {
//        if (wallArgs != null)
//        {
//            if (wallArgs.begin != wall.Begin || wallArgs.end != wall.End
//                || wallArgs.remark.CompareTo(wall.RemarkStr) != 0)
//                AddUndo(wallArgs, Revocation.ModifyWall);
//            wallArgs = null;
//        }

//        (this.ParentForm as PalaceForm).WallEditer.UnSelect();
//        this.InvalidateKeel(wall);
//    }
...
//    if (this.ceiling.SelectedIndex < 0)
//        return;
//    this.SetSelectKeel(this.ceiling.SelectedWall);
//    (this.ParentForm as PalaceForm).WallEditer.DepthTextbox.Enabled = false;

//    wall = this.ceiling.SelectedWall;
//    wallArgs = new ModifyWallRevocationEventArgs();
//    wallArgs.ceiling = this.ceiling;
//    wallArgs.wall = wall;
//    wallArgs.begin = wall.Begin;
//    wallArgs.end = wall.End;
//    wallArgs.remark = wall.RemarkStr;
//}
...
//    if (this.ceiling == null || this.ceiling.Length < 1)
//        return;
//    if (this.ceiling.SelectedWall == wall)
//        return;
//    _SelectWall(wall == null ? -1 : this.ceiling.Walles.IndexOf(wall));
//}

//private bool SelectKeel(Point pt)
//{
//    this.SelectWall(-1);
//    this.SelectKeel(-1);

//    int index = this.ceiling.GetWall(pt);
//    if (index > -1)
//    {
//        this.SelectWall(index);
//        return true;
...
//    index = this.productSet.KeelSet.GetMainKeel(pt);
//    //index = this.productSet.SelectKeel(pt);
//    if (index > -1)
//    {
//        this.SelectKeel(index);
//        return true;
...
//Point delta = new Point(this.ceiling.DrawingRect.X - dl.X,
//    this.ceiling.DrawingRect.Y - dl.Y);

//public void SetCeilingRect(RectangleF orig_rect)
//{
//    this._Refrush(ParseDrawingRect(orig_rect));
//    (this.ParentForm as PalaceForm).ScaleLabel.Text = "100%";
//}

//if (!this.ceiling.Contain(e.X, e.Y))
//{
//    this.SelectWall(-1);
//    this.SelectKeel(-1);
//}
...
//this.selectSZoneWall = sZones[i].GetWall(e.Location);
//if (this.selectSZoneWall != null)
//    this.SetSelectKeel(this.selectSZoneWall);
...
//if (this.SelectKeel(e.Location))
//{
//    if (sps.Count > 0)
//    {
//        InvalidateRect(this.productSet.BuckleSet.SelectRectangle());
//        this.productSet.BuckleSet.CancelSelect();
//    }

//    pfrm.SetObjectsMenu(true);
//    pfrm.SetPasteMenu(false);
//    //(this.ParentForm as PalaceForm).SetObjectsMenu(true);
//    //(this.ParentForm as PalaceForm).SetPasteMenu(false);
//    return;
//}
//else if (!this.ctrlDown && sps.Count > 0)
//{
//    for (int i = 0; i < sps.Count; i++)
//    {
//        if (sps[i].DrawingRect.Contains(e.Location))
//        {
//            this.movingRect = this.productSet.BuckleSet.SelectRectangle();
//            this.moving = 5;
//            pfrm.SetObjectsMenu(true);
//            pfrm.SetPasteMenu(false);
//            //(this.ParentForm as PalaceForm).SetObjectsMenu(true);
...
//this.ceiling.ID = _ceilingsRow.ID;
//this.ceiling.Name = _ceilingsRow.name;
//this.ceiling.OrderID = _ceilingsRow.order_id;

//this.ceiling.ParseData(this.ceilingRow, dataSet.ceiling_walles);
//this.ceiling.ID = this.ceilingRow.ID;
//this.ceiling.Name = this.ceilingRow.name;
//this.ceiling.OrderID = this.ceilingRow.order_id;

//public void EndDraft()
//{
//    PalaceForm pfrm = this.ParentForm as PalaceForm;
//    pfrm.WallDrafted();
//    pfrm.WallEditer.UnSelect();
//    pfrm.SetCeilingMenu(true);
...
//_szone.Close(this.ceiling);
//_szone.CalcLoca(this.ceiling);

//for (int i = 1; i < cwalles.Count; i++)
//{
//    CeilingDataSet.ceiling_wallesRow row = cwalles[i];
//    if (row.ceiling_id != ceilingRow.ID)
//        continue;
//    int _num = (row.wallnum / 10000) * 10000;
//    if (_num == 0)
//        continue;

//    for (int j = 0; j < sZones.Count; j++)
//    {
//        if (sZones[j].SzoneNum == _num)
//        {
//            _num = 0;
//            break;
//        }
...
//    {
//        SZone _szone = new SZone();
//        _szone.AddWalles(cwalles, ceilingRow.ID, _num);
//        sZones.Add(_szone);
//    }
//}

//private OrderGraphRevocationEventArgs RevoGraph()
//{
//    OrderGraphRevocationEventArgs revo_arg = new OrderGraphRevocationEventArgs();

//    revo_arg.name = this.ceiling.Name;
//    revo_arg.depth = this.ceiling.Depth;
//    revo_arg.productSet = this.productSet;

//    if (this.productSet != null)
//    {
//        if (this.productSet.BuckleSet.Products != null)
//            revo_arg.products = this.productSet.BuckleSet.Products.Clone() as AupuBuckle[];

//        revo_arg.columns = this.productSet.BuckleSet.Columns;
//        revo_arg.rows = this.productSet.BuckleSet.Rows;
//        revo_arg.paintsize = this.productSet.BuckleSet.TileUnit;

//        for (int i = 0; i < this.productSet.BuckleSet.AddedProducts.Count; i++)
//            revo_arg.additional.Add(this.productSet.BuckleSet.AddedProducts[i]);
//        for (int i = 0; i < this.productSet.KeelSet.MainKeelList.Count; i++)
//            revo_arg.mains.Add(this.productSet.KeelSet.MainKeelList[i]);
//    }

//    for (int i = 0; i < this.ceiling.Walles.Count; i++)
//        revo_arg.walles.Add(this.ceiling.Walles[i]);
//    return revo_arg;
//}

//public void EndDrawKeel()
//{
//    this.wallFuzhu = false;
//    this.keel.Cut(this.ceiling);
//    this._AddKeel();
//    this.SetSelectKeel(this.keel);
//    this.Cursor = Cursors.Default;

//    (this.ParentForm as PalaceForm).KeelDrafted();
//    //(this.ParentForm as PalaceForm).WallEditer.DepthTextbox.Enabled = true;
//    this.Invalidate();
//}

//this.fuzhuWalls.Add(this.cWall);

//this.fuzhuWalls.Add(this.cWall);
//(this.ParentForm as PalaceForm).WallEditer.DepthTextbox.Enabled = true;

//private bool CheckFuzhuEnd()
//{
//    //Wall fuzhu = fuzhuWalls[fuzhuWalls.Count - 1];
//    List<Wall> walles = this.ceiling.Walles;
//    int inters = 0;

//    for (int i = 0; i < fuzhuWalls.Count; i++)
//    {
//        Wall fuzhu = fuzhuWalls[i];
//        for (int j = 0; j < walles.Count; j++)
//        {
//            if (fuzhu.IsParallel(walles[j]))
//                continue;
//            PointF r = fuzhu.Intersect(walles[j]);
//            if (walles[j].Contains(r, true) && fuzhu.Contains(r))
//                inters++;
//        }
//    }
...
//    //    if (fuzhu.IsParallel(walles[j]))
//    //        continue;
//    //    if (walles[j].Contains(fuzhu.Intersect(walles[j]), true))
//    //        return true;
//    //    //PointF r = fuzhu.Intersect(walles[j]);
//    //    //if (walles[j].Contains(r, true))
//    //    //    return true;
//    //    //if (walles[j].Contains(r, true) && fuzhu.Contains(r, true))
//    //}
...
//if (fuzhuWalls.Count > 0 
//    && Ceiling.FilterWall(this.cWall, fuzhuWalls[fuzhuWalls.Count - 1]))
...
//this.cWall = new Wall();
//this.cWall.InitPoint(e.Location);
//this.cWall.Begin = this.ceiling.GetLogicCoord(this.cWall.BeginPaintPoint);
//this.cWall.End = this.cWall.Begin;

//if (e.Type == KeelChangeType.Length)
//{
//    this.keel.SetLength((uint)e.PValue);
//    this.EndDrawKeel();
//}

//if (this.szone != null)
//    this.szone.Draw(graphics, mainKeelPen);
//for (int i = 0; i < fuzhuWalls.Count; i++)
//{
//    fuzhuWalls[i].Draw(graphics, mainKeelPen);
//    fuzhuWalls[i].DrawLength(this.ceiling.Clockwise, graphics, 
//        arrowPen, lengthFont, strFormat);
//}

//this.ceiling.Modify(e.Keel as Wall, (uint)e.PValue);
//this.keel = new Keel();
//this.keel.InitPoint(e.Location);
//this.keel.Begin = this.ceiling.GetLogicCoord(this.keel.BeginPaintPoint);
//this.keel.End = this.keel.Begin;

//if (this.ceiling != null && !this.draft && !this.keelFilling 
//    && !this.keelDrawing && this.toolTip != null)

//public bool IsSetData
//{
//    get { return this.orderData != null; }
//}

//private bool positionTakeUp = false;

//public bool PositionTakeUp
//{
//    get { return positionTakeUp; }
//}

//private Pen arrowPen = new Pen(Color.Black, 1);
//private Pen auxiKeelPen = new Pen(Color.FromArgb(255, 135, 135, 135), 2);
...
//    else if (this.keel != null)
//    {
//        if (!(this.ParentForm as PalaceForm).WallEditer.Focused)
//            this.DeleteKeel();
//    }
//}

//srcRect.X -= 100; srcRect.Y -= 100; 
//srcRect.Width += 200; srcRect.Height += 200;

//srcRect.X -= 60; srcRect.Y -= 60;
//srcRect.Width += 120; srcRect.Height += 120;

//srcRect.X -= 100; srcRect.Y -= 80;
//srcRect.Width += 200; srcRect.Height += 160;

//float sx = rect.Width / srcRect.Width;
//float sy = rect.Height / srcRect.Height;

//if (sx > sy)
//{
//    dstRect.Width = sy * srcRect.Width;
//    //dstRect.Width = (int)Math.Round(sy * srcRect.Width, 0);
//    dstRect.X += (rect.Width - dstRect.Width) / 2;
//}
//else
//{
//    dstRect.Height = sx * srcRect.Height;
//    //dstRect.Height = (int)Math.Round(sx * srcRect.Height, 0);
//    dstRect.Y += (rect.Height - dstRect.Height) / 2;
//}
